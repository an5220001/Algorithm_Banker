...
void XuatVector() {
	...
	//tính vector tong cua Allocation
...
void KiemTraTrangThai() {
    ...
    while (counter != 0) {
        ...
        if (!safe) {
        	flag == false;
            cout<<"các quy trinh o trang thai khong an toan !!"<<endl; // các quy trinh o trang thai khong an toan
            break;
         }
		else {
            cout<<"Quy trình o trang thai an toan"<<endl;
